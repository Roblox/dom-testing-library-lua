...
return function()
	...
	it("resolves on mutation if callback throws an error", function()
		return Promise.resolve()
			:andThen(function()
				local div1 = Instance.new("Frame")
				div1:SetAttribute("data-testid", "div")
	...
	it("requires an element to exist first", function()
	...
	it("requires an unempty array of elements to exist first", function()
		-- ROBLOX deviation START: replace .rejects.toThrowErrorMatchingInlineSnapshot
		return jestExpect(function()
	...
	it("requires an element to exist first (function form)", function()
		-- ROBLOX deviation START: replace .rejects.toThrowErrorMatchingInlineSnapshot
		return jestExpect(function()
			waitForElementToBeRemoved(function()
				return nil
	...
	it("requires an unempty array of elements to exist first (function form)", function()
		-- ROBLOX deviation START: replace .rejects.toThrowErrorMatchingInlineSnapshot
		return jestExpect(function()
			waitForElementToBeRemoved(function()
				return {}
	...
	it("after successful removal, fullfills promise with empty value (undefined)", function()
		...
		return jestExpect(waitResult:expect()).toBeUndefined()
		-- ROBLOX deviation END
	end)

	it("rethrows non-testing-lib errors", function()
		local throwIt = false
	...
	it("logs timeout error when it times out", function()
		-- ROBLOX deviation START: replace .rejects.toThrowErrorMatchingInlineSnapshot
		return Promise.resolve()
			:andThen(function()
				local div = Instance.new("Frame")
	...
	it("accepts an element as an argument and waits for it to be removed from its top-most parent", function()
		return Promise.resolve()
			:andThen(function()
				local div1 = Instance.new("Frame")
				div1:SetAttribute("data-testid", "div")
